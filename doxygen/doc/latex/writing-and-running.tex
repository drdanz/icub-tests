...
\textcolor{preprocessor}{#include <rtf/dll/Plugin.h>}
\textcolor{preprocessor}{#include <rtf/TestAssert.h>}
...
ExampleTest::ExampleTest() : yarp::rtf::TestCase(\textcolor{stringliteral}{"ExampleTest"}) \{
\}
...
\textcolor{keywordtype}{void} ExampleTest::run() \{
    ...
    RTF\_TEST\_CHECK(a<b, \textcolor{stringliteral}{"a smaller then b"});
    RTF\_TEST\_CHECK(a>b, \textcolor{stringliteral}{"a bigger then b"});
    RTF\_TEST\_CHECK(a==b, \textcolor{stringliteral}{"a equal to b"});
